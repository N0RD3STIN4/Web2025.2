...
class IndexUI:
    ...
    def menu_visitante():
        op = st.sidebar.selectbox(
            "Menu", ["Entrar como Cliente", "Entrar como Profissional", "Abrir Conta"]
        )
        if op == "Entrar como Cliente":
            LoginUI.cliente()
        if op == "Entrar como Profissional":
    ...
    def menu_profissional():
        op = st.sidebar.selectbox(
            "Menu", ["Meus Dados", "Abrir Agenda", "Minha Agenda", "Confirmar Serviço"]
        )
        if op == "Meus Dados":
    ...
    def sidebar():
        if "usuario_id" not in st.session_state:
            ...
            if admin:
                ...
                if st.session_state["usuario_tipo"] == "c":
                    IndexUI.menu_cliente()
                elif st.session_state["usuario_tipo"] == "p":
